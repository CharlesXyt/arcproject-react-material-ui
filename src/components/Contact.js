...
export default function Contact(props){
    ...
    return (
        <Grid container>
            ...
            PaperProps={{style:{padding:matchesXS ? "0.5em 0" :matchesSM ? "1em 5em" : matchesMD ? "1em 10em" :"1em 15em"}}}
            >
                <DialogContent>
                ...
                style={{
                    ...
                    <Grid container direction="column">
                        ...
                        <Grid container item justify={matchesMD ? "center":undefined}>
                            <Button variant="outlined" className={classes.learnButton}  component={Link} to="/estimate" onClick={() => setValue(2)}>Learn more</Button>
                        </Grid> 
                    </Grid>
                </Grid>
                <Grid item>
                        <Button variant="contained" className={classes.estimateButton} component={Link} to="/estimate" onClick={() => setValue(5)}>Free Estimate</Button>
                </Grid>
            </Grid>
        </Grid>
    )
