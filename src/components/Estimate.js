    ...
    return (
        <Grid container>
            <Grid item container direction="column" lg>
                ...
                <Grid item style={{ marginRight: "10em", maxWidth: "50em", marginTop: "3.5em" }}>
                    <Lottie options={defaultOptions} height="100%" weight="100%" />
                </Grid>
            </Grid>
            <Grid item container direction="column" lg style={{ marginRight: "2em", marginBottom: "25em" }} alignItems="center">
                ...
                <Grid item container justify="space-between" style={{ width: "18em", marginTop: "3em" }}>
                    ...
                    <Grid item>
                        <IconButton disabled={navigationForwardDisabled()} onClick={nextQuestion}>
                            <img src={navigationForwardDisabled() ? forwardArrowDisabled:forwardArrow} alt="Next question" />
                        </IconButton>
